...
import (
	...
	"github.com/lbtsm/xrpl-go/client"
	"github.com/lbtsm/xrpl-go/client/websocket"
)

type Connection struct {
	endpoint                  string
	cli                       *client.XRPLClient
	log                       log15.Logger
	stop                      chan int
...
func (c *Connection) Connect() error {
	c.log.Info("Connecting to xrp chain...", "url", c.endpoint)

	c.cli = websocket.NewClient(&websocket.WebsocketConfig{URL: c.endpoint})
	return nil
}
...
func (c *Connection) LatestBlock() (*big.Int, error) {
	return big.NewInt(0).SetInt64(0), nil
}
